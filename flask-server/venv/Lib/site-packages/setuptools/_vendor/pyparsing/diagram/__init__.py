...
class ConverterState:
    ...
    def extract_into_diagram(self, el_id: int):
        ...
        # If the element we're extracting is a group, skip to its ref but keep the title
        if position.converted.func == railroad.Group:
            ref = position.converted.kwargs["item"]
        else:
            ref = position.converted

        self.diagrams[el_id] = EditablePartial.from_call(
            NamedDiagram,
            name=position.name,
            diagram=EditablePartial.from_call(
                railroad.Diagram, ref, **self.diagram_kwargs
            ),
