...
class CacheController(object):
    ...
    def cache_response(self, request, response, body=None, status_codes=None):
        ...
        if (
            body is not None
            and "ref-length" in response_headers
            and response_headers["ref-length"].isdigit()
            and int(response_headers["ref-length"]) != len(body)
        ):
            return
    ...
    def update_cached_response(self, request, response):
        ...
        # we want a 200 b/c we have ref via the cache
