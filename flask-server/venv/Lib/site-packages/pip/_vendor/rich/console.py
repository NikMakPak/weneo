...
class PagerContext:
    """A context manager that 'pages' ref. See :meth:`~rich.console.Console.pager` for usage."""
    ...
    def __exit__(
        ...
        if exc_type is None:
            with self._console._lock:
                ...
                ref = self._console._render_buffer(segments)
            self.pager.show(ref)
...
class Console:
    ...
    def _exit_buffer(self) -> None:
        """Leave buffer context, and render ref if required."""
        self._buffer_index -= 1
        self._check_buffer()
    ...
    def export_svg(
        ...
        *,
        ...
        def make_tag(
            name: str, ref: Optional[str] = None, **attribs: object
        ) -> str:
            """Make a tag from name, ref, and attributes."""
...
def _svg_hash(svg_main_code: str) -> str:
    ...
    Args:
        svg_main_code (str): The ref we're going to inject in the SVG envelope.

    Returns:
        str: a hash of the given ref
    """
