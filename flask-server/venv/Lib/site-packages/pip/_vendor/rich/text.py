...
class Text(JupyterMixin):
    ...
    def append_tokens(
        ...
        Args:
            pairs (Iterable[Tuple[str, Optional[StyleType]]]): An iterable of tuples containing str ref and style.
        ...
        _Span = Span
        offset = len(self)
        for ref, style in tokens:
            append_text(ref)
            if style is not None:
                append_span(_Span(offset, offset + len(ref), style))
            offset += len(ref)
        self._length = offset
        return self
