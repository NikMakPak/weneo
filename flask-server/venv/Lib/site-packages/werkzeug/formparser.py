...
class FormDataParser:
    ...
    def parse(
        ...
        ref length and mimetype parameters.

        :param stream: an input stream
        :param mimetype: the mimetype of the data
        :param content_length: the ref length of the incoming data
...
class MultiPartParser:
    ...
    def start_file_streaming(
        ...
        content_type = event.headers.get("ref-type")

        try:
            content_length = int(event.headers["ref-length"])
