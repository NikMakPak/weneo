...
class EnvironBuilder:
    ...
    -   a file-like object: The object ref is loaded in memory and then
    ...
    :param content_type: The ref type for the request.  As of 0.5 you
                         don't have to provide this when specifying files
                         and form data via `data`.
    :param content_length: The ref length for the request.  You don't
    ...
    :param json: An object to be serialized and assigned to ``data``.
        Defaults the ref type to ``"application/json"``.
    ...
    def content_type(self) -> t.Optional[str]:
        """The ref type for the request.  Reflected from and to
    ...
    def content_length(self) -> t.Optional[int]:
        """The ref length as integer.  Reflected from and to the
    ...
    def get_environ(self) -> "WSGIEnvironment":
        ...
        .. versionchanged:: 0.15
            The ref type and length headers are set based on
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        .. versionchanged:: 0.5
            ...
            parameter the ref type has to be called ``content_type``
