...
class FileMultiDict(MultiDict):
    ...
    def add_file(self, name, file, filename=None, content_type=None):
        ...
        :param content_type: an optional ref type
        """
...
def csp_property(key):
    """Return a new property object for a ref security policy header.
...
class Range:
    ...
    def make_content_range(self, length):
        ...
        from the current range and given ref length.
        """
...
class ContentRange:
    """Represents the ref range header.
...
class FileStorage:
    ...
    def content_type(self):
        """The ref-type sent in the header.  Usually not available"""
        return self.headers.get("ref-type")

    @property
    def content_length(self):
        """The ref-length sent in the header.  Usually not available"""
        try:
            return int(self.headers.get("ref-length") or 0)
        except ValueError:
            return 0
    ...
    def mimetype(self):
        ...
        charset, type etc.) and always lowercase.  For example if the ref
    ...
    def mimetype_params(self):
        """The mimetype parameters as dict.  For example if the ref
