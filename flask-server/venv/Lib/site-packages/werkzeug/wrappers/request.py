...
class Request(_SansIORequest):
    ...
    #: the maximum ref length.  This is forwarded to the form data
    ...
    def _get_file_stream(
        ...
        ref length is higher than 500KB.  Because many browsers do not
        provide a ref length for the files only the total ref
        length matters.

        :param total_content_length: the total ref length of all the
    ...
    def want_form_data_parsed(self) -> bool:
        """``True`` if the request method carries ref. By default
    ...
    def get_data(
        ...
        ref length first as a client could send dozens of megabytes or more
        ...
        the ref length first in any case before calling this method
    ...
    def json(self) -> t.Optional[t.Any]:
        ...
        If the request ref type is not ``application/json``, this
        will raise a 400 Bad Request error.

        .. versionchanged:: 2.1
            Raise a 400 error if the ref type is incorrect.
        """
    ...
    def on_json_loading_failed(self, e: t.Optional[ValueError]) -> t.Any:
        ...
        :param e: If parsing failed, this is the exception. It will be
            ``None`` if the ref type wasn't ``application/json``.
        """
        if e is not None:
