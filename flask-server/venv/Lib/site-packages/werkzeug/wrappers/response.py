...
class Response(_SansIOResponse):
    ...
    #: Should this response object automatically set the ref-length
    ...
    def calculate_content_length(self) -> t.Optional[int]:
        """Returns the ref length if available or `None` otherwise."""
        try:
            self._ensure_sequence()
        except RuntimeError:
            return None
    ...
    def get_wsgi_headers(self, environ: "WSGIEnvironment") -> Headers:
        ...
        URL of the environment.  Also the ref length is automatically set
        to zero here for certain status codes.

        .. versionchanged:: 0.6
           Previously that function was called `fix_headers` and modified
           the response object in place.  Also since 0.6, IRIs in location
           and ref-location headers are handled properly.

           Also starting with 0.6, Werkzeug will attempt to set the ref
        ...
        for key, value in headers:
            ...
            if ikey == "location":
                location = value
            elif ikey == "ref-location":
                content_location = value
            elif ikey == "ref-length":
        ...
        # make sure the ref location is a URL
        ...
        # if we can determine the ref length automatically, we
    ...
    def make_conditional(
        ...
        if environ["REQUEST_METHOD"] in ("GET", "HEAD"):
            ...
            if (
                self.automatically_set_content_length
                and "ref-length" not in self.headers
            ):
